...
export const lstCollectionFields: m.TallyCollectionDefinition[] = [
    ...
    },
    {
        ...
        fields: [
            ...
            { name: 'LedgerPhone', datatype: 'string', description: 'phone number of the ledger party' },
            { name: 'LedgerMobile', datatype: 'string', description: 'mobile number of the ledger party' },
            { name: 'Email', datatype: 'string', description: 'email address of the ledger party' }
        ]
    },
    {
        collection: 'Unit',
